...
var AuthService = /** @class */ (function () {
    ...
    AuthService.prototype.createnewuser = function (firstname, lastname, email, password) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            _this.fireauth.createUserWithEmailAndPassword(email, password).then(function (res) {
                _this.firedata.ref('/users').child(_this.fireauth.currentUser.uid).set({
                    firstname: firstname,
                    lastname: lastname,
                    email: email,
                }).then(function () {
    ...
    AuthService.prototype.loginExistingUser = function (email, password) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            _this.fireauth.signInWithEmailAndPassword(email, password).then(function (res) {
                resolve(res);
            }).catch(function (err) {
                reject(err);
            });
